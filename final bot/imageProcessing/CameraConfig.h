...
static const int COLOR_YELLOW_LfdINE_USE_PROF = 0;
...
static const double CAM_ROBOT_Y = .5; //was .5 - maybe this should be 4.5?
...
// height of camera
// in inches
static const double CAM_HEIGHT = 5.0; // inches //was 9
